...
'use strict';
  ...
  .controller('$ionDrawerVertical', ["$scope", "$element", "$attrs", "$ionicGesture", "$timeout", "$q", "$ionicHistory", "$ionDrawerVerticalDelegate", "$ionicScrollDelegate", "$interpolate", function($scope, $element, $attrs, $ionicGesture, $timeout, $q, $ionicHistory, $ionDrawerVerticalDelegate, $ionicScrollDelegate, $interpolate) {
